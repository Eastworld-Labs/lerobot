...
DEFAULT_DEPTH_PATH = DEPTH_DIR + "/{depth_key}/" + CHUNK_FILE_PATTERN + ".mp4"
DEFAULT_IMAGE_PATH = "images/{image_key}/episode-{episode_index:06d}/frame-{frame_index:06d}.png"
DEFAULT_DEPTH_IMAGE_PATH = "images/depth/{depth_key}/episode-{episode_index:06d}/frame-{frame_index:06d}.png"
...
class DatasetInfo:
    ...
    depth_path: str | None = field(default=None)
